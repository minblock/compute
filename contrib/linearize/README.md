# Linearize
Construct a linear, no-fork, best version of the Compute blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install compute_hash

https://github.com/computepay/compute_hash
...
JSON-RPC server. Running `computed` or `compute-qt -server` will be sufficient.
...
* `input`: computed blocks/ directory containing blkNNNNN.dat
