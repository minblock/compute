# Linearize
Construct a linear, no-fork, best version of the Ovo blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install ovo_hash

https://github.com/minblock/ovo_hash
...
JSON-RPC server. Running `ovod` or `ovo-qt -server` will be sufficient.
...
* `input`: ovod blocks/ directory containing blkNNNNN.dat
