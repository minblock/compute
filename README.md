ComputeCore integration/staging tree
================================
...
ComputeCore is a lite version of Bitcoin using X11 as a proof-of-work algorithm.
...
ComputeCore is released under the terms of the MIT license. See `COPYING` for more
...
If it is a simple/trivial/non-controversial change, then one of the ComputeCore
...
regularly to indicate new official, stable release versions of ComputeCore.
