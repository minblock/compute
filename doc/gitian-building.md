...
- [Building Ovo Core](#building-dash-core)
...
```bash
    ...
    From https://github.com/minblock/dash
...
[dash/gitian.sigs](https://github.com/minblock/gitian.sigs/) repository, or if that's not possible to create a pull
request.
