...
This document provides guidelines for internationalization of the Compute Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `compute_en.ts` remains unchanged.
