...
See `doc/readme-qt.rst` for instructions on building ComputeCore-Qt, the
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:minblock/compute.git compute
        cd compute
...
on an OS X 10.6 64-bit machine fails. Official release builds of ComputeCore-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `ComputeCore-Qt.app` is easy:
