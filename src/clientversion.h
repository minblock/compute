...
//! These need to be macros, as clientversion.cpp's and compute*-res.rc's voodoo requires it
...
/**
 * computed-res.rc includes this file, but it cannot cope with real c++ code.
