/* src/config/ovo-config.h.  Generated from ovo-config.h.in by configure.  */
/* src/config/ovo-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ovo Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ovo Core"
...
#define PACKAGE_BUGREPORT "https://github.com/ovopay/ovo/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ovo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ovo Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ovocore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ovo.org/"
