/* src/config/compute-config.h.  Generated from compute-config.h.in by configure.  */
/* src/config/compute-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PUTEz_CONFIG_H

#define PUTEz_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Compute Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Compute Core"
...
#define PACKAGE_BUGREPORT "https://github.com/computepay/compute/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Compute Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Compute Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "computecore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://compute.org/"
