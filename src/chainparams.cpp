...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1;//999999999999ULL; // Oct 15th, 2018
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 1;//999999999999ULL; // Apr 23th, 2019
