...
// Copyright (c) 2022 The Compute Core developers
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Compute: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Compute: 2.5 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 0; //February 23, 2019
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 0; //February 23, 2019
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1561939200; // July 1st, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 1593561600; // July 1st, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThreshold = 3226; // 80% of 4032

        // Deployment of DIP0008
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 1571097600; // Oct 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 1602720000; // Oct 15th, 2020
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000f1cbbfbacdbf"); //406648

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000218651ec5a1545473df1d200d1a62cb39aa7ba4a7d3feef4885ef8c959"); //406648
        ...
        genesis = CreateGenesisBlock(1546072292, 5120588, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000005d5bad7d75ccd5bf864160ff2cc19b113ac601e5a702ad715521e2d30f"));
        assert(genesis.hashMerkleRoot == uint256S("0x8ee8ef52b60829efa6ad473ab74367365112acd8e6aa5724fc328d0c3ec7cd01"));


        vSeeds.push_back(CDNSSeedData("seed.picsco.in"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  319890, uint256S("0x00000000e5938369019edc833f9c9f460402e8e0d22117b158c8ab15a690e4d1"))
            (  406648, uint256S("0x000000218651ec5a1545473df1d200d1a62cb39aa7ba4a7d3feef4885ef8c959"))
            (  478856, uint256S("0x00000012454d35f22a3da4679f1eaaa8bc0dcb8a926c083a2bf494d87a1dd5ff"))
        };

        chainTxData = ChainTxData{
            1644853140, // UNIX timestamp of last known number of transactions
            559115, // total number of transactions between genesis and that timestamp (the tx=... number in the SetBestChain debug.log lines)
            0.835 // estimated number of transactions per second after that timestamp
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000095d065c972d3772dde7b0ae0205f373b47ba80a4fb4dc6a2968888c768b"));
        assert(genesis.hashMerkleRoot == uint256S("0x8ee8ef52b60829efa6ad473ab74367365112acd8e6aa5724fc328d0c3ec7cd01"));
        ...
        // Testnet Compute script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Compute BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Compute BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Compute BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1546073638, 685002, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f308dd9cfff458df62bafe98d0de9653cfaf96e2a19db0d7209a325347d"));
        assert(genesis.hashMerkleRoot == uint256S("0x8ee8ef52b60829efa6ad473ab74367365112acd8e6aa5724fc328d0c3ec7cd01"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1546075179, 5171364, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000e0959d9717e59cf5806f7fc04d7a939d253098e2976a3f2a2f2bf39b4a4"));
        assert(genesis.hashMerkleRoot == uint256S("0x8ee8ef52b60829efa6ad473ab74367365112acd8e6aa5724fc328d0c3ec7cd01"));
        ...
        // Regtest Compute addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Compute script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Compute BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Compute BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Compute BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
