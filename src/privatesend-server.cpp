...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Ovo related functionality
...
/*
    ...
    allow endless transaction that would bloat Ovo and make it unusable. To
